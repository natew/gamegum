module HasManyFriends
  ...
  module UserExtensions
    ...
    module InstanceMethods
      ...
      # Accepts a user object and returns true if friend is
      # a pending friend of self
      def is_pending_friend_with?(friend)
        self.pending_friends_by_me.include?(friend)
      end
      
      # Accepts a user object and returns true if self is
      # a pending friend of friend
      def is_pending_friend_of?(friend)
